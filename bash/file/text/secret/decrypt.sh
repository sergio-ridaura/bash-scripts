...
SCRIPT_NAME="file_text_secret_decrypt"
SCRIPT_DESCRIPTION="Decrypts the content of a text file."
SCRIPT_DESCRIPTION_ES="Descifra el contenido de un archivo de texto."
...
if [ "$ARG_BASH_H" != true ]; then
  openssl enc -d -aes-256-cbc -in $input -out $output -pbkdf2 -k $password
fi
